<body>
    ...
    <?php
    include("C:/xampp/htdocs/QLTV/QLTV/Public/public/header.php");
    ...
    <div id="wrapper">
                    ...
                    <div class="col-lg-12">
                        <div id="sidebar-wrapper">
                            <ul class="sidebar-nav">
                                ...
                                <li class="nav-item "> <a class="nav-link" href="index_admin.php"> <i class="fa fa-home"></i>Trang Chủ</a> </li>
                                <li class="nav-item "> <a class="nav-link" href="department/index_dpm.php"><i class="fas fa-hospital-alt"></i></i>Quản Lý Khoa</a> </li>
                                <li class="nav-item "> <a class="nav-link" href="subject/index_sbj.php"> <i class="fas fa-book"></i>Quản Lý Môn Học</a> </li>
                                <li class="nav-item "> <a class="nav-link" href="teacher/index_tch.php"> <i class="fas fa-chalkboard-teacher"></i></i>Quản Lý Giảng Viên</a> </li>
                                <li class="nav-item "> <a class="nav-link" href="student/index_std.php"><i class="fab fa-slideshare"></i></i>Quản Lý Sinh Viên</a> </li>
                                <li class="nav-item "> <a class="nav-link" href="subjectClass/index-sbj_cl.php"><i class="fab fa-slideshare"></i></i>Quản Lý Lịch Học</a></li>
                                <li class="nav-item "> <a class="nav-link" href="student_subject/open_close_regis1.php"><i class="fas fa-clipboard-check"></i></i>Kích Hoạt</a> </li>
                            </ul>
                        </div>
                        ...
                        <div class="container main-content">
                            <br>
                            <button type="button" class="btn btn-success" id="qlTheLoai">Quản lý thể loại</button>
                            <div id="data">
        ...
        <script src="http://localhost:8080/QLTV/Public/js/category.js"></script>
