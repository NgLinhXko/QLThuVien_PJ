					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<div class="tg-innerbannercontent">
							...
							<ol class="tg-breadcrumb">
								...
								<li class="tg-active">Thể loại</li>
							</ol>
						</div>
					</div>
				</div>
									...
									<div class="tg-products">
										...
										<div class="tg-productgrid">
											<div class="tg-refinesearch">
												<span>Tổng số sách: <?= $total_book_cate ?></span>
												<form class="tg-formtheme tg-formsortshoitems">
													<fieldset>
														<div class="form-group">
															<select class="form-select" aria-label="Default select example">
																<option colum="id_b" value="DESC" selected>Mới nhất</option>
																<option colum="numBorr" value="DESC">Mượn nhiều nhất</option>
																<option colum="price_b" value="ASC">Giá cọc thấp đến cao</option>
																<option colum="price_b" value="DESC">Giá cọc cao đến thấp</option>
															</select>
														</div>
		...
		$(document).on("click", ".page-item", function() {
			...
			$.ajax({
				...
				success: function(dt) {
					...
					$('html, body').animate({
						scrollTop: $("#data_cate").offset().top
					}, 500);
				}
			})
		})
